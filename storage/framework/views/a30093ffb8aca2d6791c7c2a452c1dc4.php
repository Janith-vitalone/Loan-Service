                                    ...
                                    <div class="d-flex">
                                        ...
                                        <div class="flex-shrink-0 ms-4">
                                            <ul class="list-inline tasks-list-menu mb-0">
                                                <li class="list-inline-item"><a href="<?php echo e(URL::asset('/apps-tasks-details')); ?>"><i class="ri-eye-fill align-bottom me-2 text-muted"></i></a></li>
                                    ...
                                    <li>
                                        <div class="form-check d-flex align-items-center">
                                            ...
                                            <label class="form-check-label d-flex align-items-center" for="mary-gant">
                                                <span class="flex-shrink-0">
                                                    <img src="<?php echo e(URL::asset('assets/images/users/avatar-4.jpg')); ?>" alt="" class="avatar-xxs rounded-circle">
                                                </span>
                                    ...
                                    <li>
                                        <div class="form-check d-flex align-items-center">
                                            ...
                                            <label class="form-check-label d-flex align-items-center" for="diego-norris">
                                                <span class="flex-shrink-0">
                                                    <img src="<?php echo e(URL::asset('assets/images/users/avatar-9.jpg')); ?>" alt="" class="avatar-xxs rounded-circle">
                                                </span>
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Tarun\Laravel Admins\velzon_laravel\Laravel\minimal\resources\views/apps-tasks-list-view.blade.php ENDPATH**/ ?>