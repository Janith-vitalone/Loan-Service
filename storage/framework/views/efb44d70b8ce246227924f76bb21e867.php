                                        ...
                                        <div class="swiper-wrapper">
                                            <div class="swiper-slide">
                                                <div class="d-flex align-items-center border border-dashed rounded p-2">
                                                    <div class="flex-shrink-0">
                                                        <img src="<?php echo e(URL::asset('build/images/small/img-12.jpg')); ?>" alt="" width="65"
                                                            class="rounded" />
                                                    </div>
                                            ...
                                            <div class="swiper-slide">
                                                <div class="d-flex align-items-center border border-dashed rounded p-2">
                                                    <div class="flex-shrink-0">
                                                        <img src="<?php echo e(URL::asset('build/images/small/img-11.jpg')); ?>" alt="" width="65"
                                                            class="rounded" />
                                                    </div>
                                                    <div class="flex-grow-1 ms-2">
                                                        <a href="javascript:void(0);"
                                            ...
                                            <div class="swiper-slide">
                                                <div class="d-flex align-items-center border border-dashed rounded p-2">
                                                    <div class="flex-shrink-0">
                                                        <img src="<?php echo e(URL::asset('build/images/small/img-10.jpg')); ?>" alt="" width="65"
                                                            class="rounded" />
                                                    </div>
                                                    <div class="flex-grow-1 ms-2">
                                                        <a href="javascript:void(0);"
                                            ...
                                            <div class="swiper-slide">
                                                <div class="d-flex align-items-center border border-dashed rounded p-2">
                                                    <div class="flex-shrink-0">
                                                        <img src="<?php echo e(URL::asset('build/images/small/img-9.jpg')); ?>" alt="" width="65"
                                                            class="rounded" />
                                                    </div>
                                                    <div class="flex-grow-1 ms-2">
                                                        <a href="javascript:void(0);"
                                            ...
                                            <div class="swiper-slide">
                                                <div class="d-flex align-items-center border border-dashed rounded p-2">
                                                    <div class="flex-shrink-0">
                                                        <img src="<?php echo e(URL::asset('build/images/small/img-8.jpg')); ?>" alt="" width="65"
                                                            class="rounded" />
                                                    </div>
                                                    <div class="flex-grow-1 ms-2">
                                                        <a href="javascript:void(0);"
                                            ...
                                            <div class="swiper-slide">
                                                <div class="d-flex align-items-center border border-dashed rounded p-2">
                                                    <div class="flex-shrink-0">
                                                        <img src="<?php echo e(URL::asset('build/images/small/img-7.jpg')); ?>" alt="" width="65"
                                                            class="rounded" />
                                                    </div>
                                                    <div class="flex-grow-1 ms-2">
                                                        <a href="javascript:void(0);"
                                            ...
                                            <div class="swiper-slide">
                                                <div class="d-flex align-items-center border border-dashed rounded p-2">
                                                    <div class="flex-shrink-0">
                                                        <img src="<?php echo e(URL::asset('build/images/small/img-6.jpg')); ?>" alt="" width="65"
                                                            class="rounded" />
                                                    </div>
                                                    <div class="flex-grow-1 ms-2">
                                                        <a href="javascript:void(0);"
                                            ...
                                            <div class="swiper-slide">
                                                <div class="d-flex align-items-center border border-dashed rounded p-2">
                                                    <div class="flex-shrink-0">
                                                        <img src="<?php echo e(URL::asset('build/images/small/img-5.jpg')); ?>" alt="" width="65"
                                                            class="rounded" />
                                                    </div>
                                                    <div class="flex-grow-1 ms-2">
                                                        <a href="javascript:void(0);"
                                            ...
                                            <div class="swiper-slide">
                                                <div class="d-flex align-items-center border border-dashed rounded p-2">
                                                    <div class="flex-shrink-0">
                                                        <img src="<?php echo e(URL::asset('build/images/small/img-3.jpg')); ?>" alt="" width="65"
                                                            class="rounded" />
                                                    </div>
                                                    <div class="flex-grow-1 ms-2">
                                                        <a href="javascript:void(0);"
                                            ...
                                            <div class="gallery-container">
                                                <a class="image-popup" href="<?php echo e(URL::asset('build/images/small/img-1.jpg')); ?>" title="">
                                                    <img class="gallery-img img-fluid mx-auto"
                                                        src="<?php echo e(URL::asset('build/images/small/img-1.jpg')); ?>" alt="" />
                                        ...
                                        <div class="gallery-box card">
                                            <div class="gallery-container">
                                                <a class="image-popup" href="<?php echo e(URL::asset('build/images/small/img-2.jpg')); ?>" title="">
                                                    <img class="gallery-img img-fluid mx-auto"
                                                        src="<?php echo e(URL::asset('build/images/small/img-2.jpg')); ?>" alt="" />
                                                    <div class="gallery-overlay">
                                        ...
                                        <div class="gallery-box card">
                                            <div class="gallery-container">
                                                <a class="image-popup" href="<?php echo e(URL::asset('build/images/small/img-3.jpg')); ?>" title="">
                                                    <img class="gallery-img img-fluid mx-auto"
                                                        src="<?php echo e(URL::asset('build/images/small/img-3.jpg')); ?>" alt="" />
                                                    <div class="gallery-overlay">
                                        ...
                                        <div class="gallery-box card">
                                            <div class="gallery-container">
                                                <a class="image-popup" href="<?php echo e(URL::asset('build/images/small/img-4.jpg')); ?>" title="">
                                                    <img class="gallery-img img-fluid mx-auto"
                                                        src="<?php echo e(URL::asset('build/images/small/img-4.jpg')); ?>" alt="" />
                                                    <div class="gallery-overlay">
                                        ...
                                        <div class="gallery-box card">
                                            <div class="gallery-container">
                                                <a class="image-popup" href="<?php echo e(URL::asset('build/images/small/img-5.jpg')); ?>" title="">
                                                    <img class="gallery-img img-fluid mx-auto"
                                                        src="<?php echo e(URL::asset('build/images/small/img-5.jpg')); ?>" alt="" />
                                                    <div class="gallery-overlay">
                                        ...
                                        <div class="gallery-box card">
                                            <div class="gallery-container">
                                                <a class="image-popup" href="<?php echo e(URL::asset('build/images/small/img-6.jpg')); ?>" title="">
                                                    <img class="gallery-img img-fluid mx-auto"
                                                        src="<?php echo e(URL::asset('build/images/small/img-6.jpg')); ?>" alt="" />
                                                    <div class="gallery-overlay">
                                        ...
                                        <div class="gallery-box card">
                                            <div class="gallery-container">
                                                <a class="image-popup" href="<?php echo e(URL::asset('build/images/small/img-7.jpg')); ?>" title="">
                                                    <img class="gallery-img img-fluid mx-auto"
                                                        src="<?php echo e(URL::asset('build/images/small/img-7.jpg')); ?>" alt="" />
                                                    <div class="gallery-overlay">
                                        ...
                                        <div class="gallery-box card">
                                            <div class="gallery-container">
                                                <a class="image-popup" href="<?php echo e(URL::asset('build/images/small/img-8.jpg')); ?>" title="">
                                                    <img class="gallery-img img-fluid mx-auto"
                                                        src="<?php echo e(URL::asset('build/images/small/img-8.jpg')); ?>" alt="" />
                                                    <div class="gallery-overlay">
                                                        <h5 class="overlay-caption">Glasses and laptop from above</h5>
                                                    </div>
                                                </a>
                                        ...
                                        <div class="gallery-box card">
                                            <div class="gallery-container">
                                                <a class="image-popup" href="<?php echo e(URL::asset('build/images/small/img-9.jpg')); ?>" title="">
                                                    <img class="gallery-img img-fluid mx-auto"
                                                        src="<?php echo e(URL::asset('build/images/small/img-9.jpg')); ?>" alt="" />
                                                    <div class="gallery-overlay">
                                        ...
                                        <div class="gallery-box card">
                                            <div class="gallery-container">
                                                <a class="image-popup" href="<?php echo e(URL::asset('build/images/small/img-10.jpg')); ?>" title="">
                                                    <img class="gallery-img img-fluid mx-auto"
                                                        src="<?php echo e(URL::asset('build/images/small/img-10.jpg')); ?>" alt="" />
                                                    <div class="gallery-overlay">
                                        ...
                                        <div class="gallery-box card">
                                            <div class="gallery-container">
                                                <a class="image-popup" href="<?php echo e(URL::asset('build/images/small/img-11.jpg')); ?>" title="">
                                                    <img class="gallery-img img-fluid mx-auto"
                                                        src="<?php echo e(URL::asset('build/images/small/img-11.jpg')); ?>" alt="" />
                                                    <div class="gallery-overlay">
                                        ...
                                        <div class="gallery-box card">
                                            <div class="gallery-container">
                                                <a class="image-popup" href="<?php echo e(URL::asset('build/images/small/img-12.jpg')); ?>" title="">
                                                    <img class="gallery-img img-fluid mx-auto"
                                                        src="<?php echo e(URL::asset('build/images/small/img-12.jpg')); ?>" alt="" />
                                                    <div class="gallery-overlay">
                                ...
                                <div class="col-lg-6">
                                    <div class="card border">
                                        <div class="card-body">
                                            <div class="d-sm-flex">
                                                <div class="flex-shrink-0">
                                                    <img src="<?php echo e(URL::asset('build/images/small/img-1.jpg')); ?>" alt="" width="115"
                                                        class="rounded-1" />
                                                </div>
                                ...
                                <div class="col-lg-6">
                                    <div class="card border">
                                        <div class="card-body">
                                            <div class="d-sm-flex">
                                                <div class="flex-shrink-0">
                                                    <img src="<?php echo e(URL::asset('build/images/small/img-2.jpg')); ?>" alt="" width="115"
                                                        class="rounded-1" />
                                                </div>
                                                <div class="flex-grow-1 ms-sm-4 mt-3 mt-sm-0">
                                                    <ul class="list-inline mb-2">
                                ...
                                <div class="col-lg-6">
                                    <div class="card border">
                                        <div class="card-body">
                                            <div class="d-sm-flex">
                                                <div class="flex-shrink-0">
                                                    <img src="<?php echo e(URL::asset('build/images/small/img-3.jpg')); ?>" alt="" width="115"
                                                        class="rounded-1" />
                                                </div>
                                                <div class="flex-grow-1 ms-sm-4 mt-3 mt-sm-0">
                                                    <ul class="list-inline mb-2">
                                ...
                                <div class="col-lg-6">
                                    <div class="card border">
                                        <div class="card-body">
                                            <div class="d-sm-flex">
                                                <div class="flex-shrink-0">
                                                    <img src="<?php echo e(URL::asset('build/images/small/img-4.jpg')); ?>" alt="" width="115"
                                                        class="rounded-1" />
                                                </div>
                                                <div class="flex-grow-1 ms-sm-4 mt-3 mt-sm-0">
                                                    <ul class="list-inline mb-2">
                                ...
                                <div class="col-lg-6">
                                    <div class="card border">
                                        <div class="card-body">
                                            <div class="d-sm-flex">
                                                <div class="flex-shrink-0">
                                                    <img src="<?php echo e(URL::asset('build/images/small/img-5.jpg')); ?>" alt="" width="115"
                                                        class="rounded-1" />
                                                </div>
                                                <div class="flex-grow-1 ms-sm-4 mt-3 mt-sm-0">
                                                    <ul class="list-inline mb-2">
                                ...
                                <div class="col-lg-6">
                                    <div class="card border">
                                        <div class="card-body">
                                            <div class="d-sm-flex">
                                                <div class="flex-shrink-0">
                                                    <img src="<?php echo e(URL::asset('build/images/small/img-6.jpg')); ?>" alt="" width="115"
                                                        class="rounded-1" />
                                                </div>
                                                <div class="flex-grow-1 ms-sm-4 mt-3 mt-sm-0">
                                                    <ul class="list-inline mb-2">
                                ...
                                <div class="col-lg-6">
                                    <div class="card border">
                                        <div class="card-body">
                                            <div class="d-sm-flex">
                                                <div class="flex-shrink-0">
                                                    <img src="<?php echo e(URL::asset('build/images/small/img-7.jpg')); ?>" alt="" width="115"
                                                        class="rounded-1" />
                                                </div>
                                                <div class="flex-grow-1 ms-sm-4 mt-3 mt-sm-0">
                                                    <ul class="list-inline mb-2">
                                ...
                                <div class="col-lg-6">
                                    <div class="card border">
                                        <div class="card-body">
                                            <div class="d-sm-flex">
                                                <div class="flex-shrink-0">
                                                    <img src="<?php echo e(URL::asset('build/images/small/img-8.jpg')); ?>" alt="" width="115"
                                                        class="rounded-1" />
                                                </div>
                                                <div class="flex-grow-1 ms-sm-4 mt-3 mt-sm-0">
                                                    <ul class="list-inline mb-2">
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/Loan_serv_L/resources/views/pages-search-results.blade.php ENDPATH**/ ?>