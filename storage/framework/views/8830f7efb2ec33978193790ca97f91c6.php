            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form action="#">
                        ...
                        <div class="mt-4">
                            <h5 class="fs-18 mb-3 ">Client Banking Details</h5>
                            <div class="mt-4">
                                <div class="row">
                                    <div class="col-xl-6">
                                        <div class="mb-3">
...
<?php echo $__env->make('layouts.sales layout.layouts-detached', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/Loan_serv_L/resources/views/sales/loan-details-form.blade.php ENDPATH**/ ?>