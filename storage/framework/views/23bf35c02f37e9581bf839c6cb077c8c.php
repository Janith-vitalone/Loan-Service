                    ...
                    <table class="table table-borderless align-middle">
                        <tbody>
                            <tr>
                                <td>
                                    <div class="d-flex align-items-center">
                                        <img src="<?php echo e(URL::asset('build/images/nft/img-03.jpg')); ?>" alt="" class="avatar-sm object-cover rounded-circle">
                                        <div class="ms-2">
                            ...
                            <tr>
                                <td>
                                    <div class="d-flex align-items-center">
                                        <img src="<?php echo e(URL::asset('build/images/nft/img-04.jpg')); ?>" alt="" class="avatar-sm object-cover rounded-circle">
                                        <div class="ms-2">
                                            <a href="apps-nft-item-details">
                            ...
                            <tr>
                                <td>
                                    <div class="d-flex align-items-center">
                                        <img src="<?php echo e(URL::asset('build/images/nft/img-05.jpg')); ?>" alt="" class="avatar-sm object-cover rounded-circle">
                                        <div class="ms-2">
                                            <a href="apps-nft-item-details">
                            ...
                            <tr>
                                <td>
                                    <div class="d-flex align-items-center">
                                        <img src="<?php echo e(URL::asset('build/images/nft/img-02.jpg')); ?>" alt="" class="avatar-sm object-cover rounded-circle">
                                        <div class="ms-2">
                                            <a href="apps-nft-item-details">
                    ...
                    <table class="table table-borderless align-middle">
                        <tbody>
                            <tr>
                                <td>
                                    <div class="d-flex align-items-center">
                                        <img src="<?php echo e(URL::asset('build/images/users/avatar-1.jpg')); ?>" alt="" class="avatar-sm object-cover rounded-circle">
                                        <div class="ms-2">
                                            <a href="#!">
                            ...
                            <tr>
                                <td>
                                    <div class="d-flex align-items-center">
                                        <img src="<?php echo e(URL::asset('build/images/users/avatar-3.jpg')); ?>" alt="" class="avatar-sm object-cover rounded-circle">
                                        <div class="ms-2">
                                            <a href="#!">
                            ...
                            <tr>
                                <td>
                                    <div class="d-flex align-items-center">
                                        <img src="<?php echo e(URL::asset('build/images/users/avatar-5.jpg')); ?>" alt="" class="avatar-sm object-cover rounded-circle">
                                        <div class="ms-2">
                                            <a href="#!">
                            ...
                            <tr>
                                <td>
                                    <div class="d-flex align-items-center">
                                        <img src="<?php echo e(URL::asset('build/images/users/avatar-10.jpg')); ?>" alt="" class="avatar-sm object-cover rounded-circle">
                                        <div class="ms-2">
                                            <a href="#!">
                            ...
                            <tr>
                                <td>
                                    <div class="d-flex align-items-center">
                                        <img src="<?php echo e(URL::asset('build/images/users/avatar-8.jpg')); ?>" alt="" class="avatar-sm object-cover rounded-circle">
                                        <div class="ms-2">
                                            <a href="#!">
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/Loan_serv_L/resources/views/apps-nft-auction.blade.php ENDPATH**/ ?>