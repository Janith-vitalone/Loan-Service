                                            ...
                                            <ul class="departments">
                                                ...
                                                <li class="department">
                                                    ...
                                                    <ul>
                                                        <li><a href="javascript:void(0);"
                                                                class="border shadow-none"><span>Sign
                                                                    Up</span></a></li>
                                                        <li><a href="javascript:void(0);"
                                                ...
                                                <li class="department">
                                                    ...
                                                    <ul>
                                                        ...
                                                        <li><a href="javascript:void(0);"
                                                                class="border shadow-none"><span>Connect
                                                ...
                                                <li class="department">
                                                    ...
                                                    <ul>
                                                        ...
                                                        <li><a href="javascript:void(0);"
                                                                class="border shadow-none"><span>Art</span></a>
                                                        </li>
                                                        <li><a href="javascript:void(0);"
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/Loan_serv_L/resources/views/pages-sitemap.blade.php ENDPATH**/ ?>