<?php $__env->startSection('title'); ?>
    <?php echo app('translator')->get('translation.sellers-details'); ?>
<?php $__env->stopSection(); ?>
<?php $__env->startSection('css'); ?>
<link href="<?php echo e(URL::asset('assets/libs/gridjs/theme/mermaid.min.css')); ?>" rel="stylesheet">
        ...
        <div class="col-xxl-9">
                ...
                <div class="card-body p-0 pb-2">
                    <div>
                        <div id="customer_impression_charts"
                            data-colors='["--vz-primary-rgb, 0.1", "--vz-primary", "--vz-primary-rgb, 0.6"]'
            ...
            <div class="row g-4 mb-3">
                <div class="col-sm-auto">
                    <div>
                        <a href="<?php echo e(URL::asset('/apps-ecommerce-add-product')); ?>" class="btn btn-primary"><i
...
<script src="<?php echo e(URL::asset('assets/libs/gridjs/gridjs.umd.js')); ?>"></script>
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Tarun\Laravel Admins\velzon_laravel\Laravel\minimal\resources\views/apps-ecommerce-seller-details.blade.php ENDPATH**/ ?>