        ...
        <div class="col-lg-12">
            <div class="card">
                <div class="card-header">
                    <h4 class="card-title mb-0">Cheque Cancel</h4>
                </div><!-- end card header -->
                <div class="card-body">
                    <form action="">
                        ...
                        <div class="col-md-6 mb-2">
                            <label for="validationDefault03" class="form-label">Cheque No <span class="text-danger">*</span></label>
                            <input type="text" class="form-control" id="validationDefault03" required>
                        </div>
                        <div class="col-md-6 mb-2">
                        ...
                        <div class="col-md-6 mb-2">
                            <label for="validationDefault03" class="form-label">Cheque Date</label>
                            <input type="text" class="form-control" id="validationDefault03" required>
                        </div>
                        <div class="col-md-6 mb-2">
                        ...
                        <div class="col-md-6 mb-2">
                            ...
                            <select class="form-select mb-3" aria-label=".form-select-lg example" required>
                                <option selected>Cheque Amount Is wrong</option>
                                <option value="1">One</option>
                            </select>
                        </div>
                        <div class="text-end">
...
<?php echo $__env->make('layouts.sales layout.layouts-detached', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/Loan_serv_L/resources/views/sales/installment/cheque-cancel.blade.php ENDPATH**/ ?>