    ...
    <div class="row mb-3">
        <div class="col-xl-8">
            ...
            <div class="text-end mb-4">
                <a href="<?php echo e(URL::asset('/apps-ecommerce-checkout')); ?>" class="btn btn-primary btn-label right ms-auto"><i
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Tarun\Laravel Admins\velzon_laravel\Laravel\minimal\resources\views/apps-ecommerce-cart.blade.php ENDPATH**/ ?>