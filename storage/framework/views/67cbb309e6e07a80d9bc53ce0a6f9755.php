                            ...
                            <div class="col-xxl-6">
                                ...
                                <div class="toast fade show" role="alert" aria-live="assertive" data-bs-autohide="false"
                                    ...
                                    <div class="toast-header">
                                        <img src="<?php echo e(URL::asset('build/images/logo-sm.png')); ?>" class="rounded me-2" alt="..." height="20">
                                ...
                                <div class="mt-4">
                                    ...
                                    <div class="p-3 bg-light">
                                        <div class="toast fade show" role="alert" aria-live="assertive"
                                            ...
                                            <div class="toast-header">
                                                <img src="<?php echo e(URL::asset('build/images/logo-sm.png')); ?>" class="rounded me-2" alt="..."
                                                    height="20">
                                                <span class="fw-semibold me-auto">Velzon</span>
                ...
                <div class="card-body">
                    ...
                    <div class="live-preview">
                        ...
                        <div class="position-relative">
                            ...
                            <div style="z-index: 11">
                                <div id="borderedTost3" class="toast toast-border-info overflow-hidden mt-3" role="alert"
                                        ...
                                        <div class="d-flex align-items-center">
                                            ...
                                            <div class="flex-grow-1">
                                                <h6 class="mb-0">Something is very wrong! <a
                                                        href="javascript:void(0);" class="text-decoration-underline">See
                                                        detailed report.</a></h6>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="mt-4">
                                    ...
                                    <div class="d-flex align-items-center flex-wrap gap-2">
                                        <button type="button" data-toast
                                            ...
                                            data-toast-offset data-toast-close="close" class="btn btn-light w-xs">Click
                                            Me</button>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="mt-4">
                                    ...
                                    <div class="d-flex align-items-center flex-wrap gap-2">
                                        <button type="button" data-toast data-toast-text="Toast Duration 5s"
                                            data-toast-gravity="top" data-toast-position="right" data-toast-duration="5000"
                                            class="btn btn-light w-xs">Click Me</button>
                                    </div>
                                </div>
                            </div>
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/Loan_serv_L/resources/views/ui-notifications.blade.php ENDPATH**/ ?>