        ...
        <div class="col-sm-6 col-xl-3">
            <div class="card">
                ...
                <div class="card-footer">
                    ...
                    <a href="javascript:void(0);" class="card-link">Bookmark <i
            ...
            <div class="row">
                <div class="col-xxl-4 col-lg-6">
                    <div class="card">
                        ...
                        <div class="card-footer">
                            <a href="javascript:void(0);" class="link-primary float-end">Read More <i
                ...
                <div class="col-xxl-4 col-lg-6">
                    <div class="card">
                        ...
                        <div class="card-footer">
                            <a href="javascript:void(0);" class="link-primary float-end">Payment Now <i
                                    class="ri-arrow-right-s-line align-middle ms-1 lh-1"></i></a>
                            ...
                            <blockquote class="card-blockquote mb-0">
                                ...
                                <figure class="mb-0">
                                    <blockquote class="blockquote">
                                        <p class="lead">"A business consulting agency is involved in the
    ...
    <div class="row">
        ...
        <div class="col-xl-4">
            <div class="card">
                ...
                <div class="card-body">
                    <p class="text-muted">After gathering lots of different opinions and graphic design basics, I came
                        up with a list of 30 graphic design tips that you can start implementing. Each design is a new,
                        unique piece of art birthed into this world.</p>
                    <p class="text-muted mb-0">Art party locavore wolf cliche high life echo park Austin.</p>
                </div>
                <div class="card-footer">
                    <div class="hstack gap-2 justify-content-end">
                        <a href="javascript:void(0)" class="btn btn-link btn-sm"><i
            ...
            <div class="row">
                ...
                <div class="col-xxl-4 col-lg-6">
                    <div class="card">
                        ...
                        <img class="card-img rounded-0 img-fluid" src="<?php echo e(URL::asset('build/images/small/img-10.jpg')); ?>"
                            alt="Card image cap">
                        <div class="card-footer">
                            <p class="card-text mb-0">
                                Last updated 3 mins ago
            ...
            <div class="row">
                        ...
                        <div class="row g-0">
                            <div class="col-md-4">
                                <img class="rounded-start img-fluid h-100 object-cover"
                                    src="<?php echo e(URL::asset('build/images/small/img-12.jpg')); ?>" alt="Card image">
                            </div>
                            <div class="col-md-8">
                                <div class="card-header">
                ...
                <div class="col-xxl-6">
                    <div class="card">
                        <div class="row g-0">
                            ...
                            <div class="col-md-4">
                                <img class="rounded-end img-fluid h-100 object-cover" src="<?php echo e(URL::asset('build/images/small/img-4.jpg')); ?>"
                                    alt="Card image">
                            </div>
                        </div>
                    </div><!-- end card -->
                ...
                <div class="col-xxl-6">
                    <div class="card">
                        <div class="row g-0">
                            <div class="col-md-4">
                                <img class="rounded-start img-fluid h-100 object-cover" src="<?php echo e(URL::asset('build/images/small/img-9.jpg')); ?>"
                                    alt="Card image">
                            </div>
                            <div class="col-md-8">
                                <div class="card-body">
                ...
                <div class="col-xxl-6">
                    <div class="card">
                        <div class="row g-0">
                            ...
                            <div class="col-md-4">
                                <img class="rounded-end img-fluid h-100 object-cover" src="<?php echo e(URL::asset('build/images/small/img-2.jpg')); ?>"
                                    alt="Card image">
                            </div>
                        </div>
                    </div><!-- end card -->
                            ...
                            <div class="d-flex align-items-center">
                                ...
                                <div class="flex-grow-1 ms-3">
                                    <p class="card-text"><span class="fw-medium">Jeffrey Montgomery</span>
                                        (Graphic Designer) started a new conversation.</p>
                                </div>
                            </div>
                        </div>
                        <div class="card-footer">
                            ...
                            <div class="d-flex align-items-center">
                                ...
                                <div class="flex-grow-1 ms-3">
                                    <p class="card-text"><span class="fw-medium">Charles Dickens</span>
                                        (Financial Analyst) started a new conversation.</p>
                                </div>
                            </div>
                        </div>
                        <div class="card-footer">
                    ...
                    <div class="d-flex align-items-center">
                        ...
                        <div class="flex-grow-1 ms-3">
                            <p class="card-text"><span class="fw-medium">Betty Richards</span> (Back End
                                Developer) started a new conversation.</p>
                        </div>
                    </div>
                </div>
                <div class="card-footer">
            ...
            <div class="row">
                ...
                <div class="col-xxl-4">
                    <div class="card border card-border-success">
                        ...
                        <div class="card-body">
                            <p class="card-text">They all have something to say beyond the words on the page. They can
            ...
            <div class="card border card-border-warning">
                ...
                <div class="card-body">
                    <p class="card-text">They all have something to say beyond the words on the page. They can come
                        across as casual or neutral, exotic or graphic. Cosby sweater eu banh mi, qui irure terry richardson
                        ex squid.</p>
                    <div class="text-end">
            ...
            <div class="card h-100">
                ...
                <div class="card-body">
                    ...
                    <p class="card-text">Exercitation +1 labore velit, blog sartorial PBR leggings next level wes
                        anderson artisan four loko farm-to-table craft beer twee. ommodo enim craft beer mlkshk aliquip jean
                        shorts ullamco.</p>
                </div>
                <div class="card-footer">
                    <p class="card-text">
            ...
            <div class="row" data-masonry='{"percentPosition": true }'>
                ...
                <div class="col-sm-6 col-lg-4">
                    <div class="card">
                        ...
                        <img class="card-img rounded-0 img-fluid" src="<?php echo e(URL::asset('build/images/small/img-8.jpg')); ?>"
                            alt="Card image cap" />
                        <div class="card-footer">
                            <p class="card-text mb-0">
                                Last updated 3 mins ago
                ...
                <div class="col-sm-6 col-lg-4">
                    <div class="card">
                        ...
                        <div class="card-footer">
                            <a href="javascript:void(0);" class="float-end">Read More <i
                                    class="ri-arrow-right-s-line align-middle ms-1 lh-1"></i></a>
                            <p class="text-muted mb-0">1 days Ago</p>
                        </div>
                    </div>
                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="d-flex position-relative">
                                <img src="<?php echo e(URL::asset('build/images/users/avatar-3.jpg')); ?>" class="flex-shrink-0 me-3 avatar-xl rounded"
                                    alt="..." />
                                <div>
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/Loan_serv_L/resources/views/ui-cards.blade.php ENDPATH**/ ?>