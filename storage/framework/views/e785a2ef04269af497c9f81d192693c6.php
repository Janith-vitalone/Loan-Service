...
<?php $__env->startSection('css'); ?>
    <link href="<?php echo e(URL::asset('build/libs/shepherd.js/css/shepherd.css')); ?>" rel="stylesheet" type="text/css" />
                            ...
                            <div class="col-lg-5">
                                <div class="text-center mt-4 mb-5">
                                    <div class="py-3 px-2 d-inline-block" id="logo-tour">
                                        <img src="<?php echo e(URL::asset('build/images/logo-dark.png')); ?>" class="card-logo card-logo-dark" alt="logo"
                                            height="17">
                                        <img src="<?php echo e(URL::asset('build/images/logo-light.png')); ?>" class="card-logo card-logo-light" alt="logo"
                                            height="17">
                                    </div>
...
<?php $__env->startSection('script'); ?>
    <script src="<?php echo e(URL::asset('build/libs/shepherd.js/js/shepherd.min.js')); ?>"></script>
    <script src="<?php echo e(URL::asset('build/js/pages/tour.init.js')); ?>"></script>

    <script src="<?php echo e(URL::asset('build/js/app.js')); ?>"></script>

<?php $__env->stopSection(); ?>

<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/Loan_serv_L/resources/views/advance-ui-tour.blade.php ENDPATH**/ ?>