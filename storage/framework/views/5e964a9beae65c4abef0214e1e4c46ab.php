...
<link href="<?php echo e(URL::asset('assets/libs/swiper/swiper-bundle.min.css')); ?>" rel="stylesheet"  />
<?php $__env->stopSection(); ?>
                                ...
                                <div class="row align-items-end g-0">
                                    ...
                                    <div class="col-6">
                                        <div class="apex-charts crypto-widget"
                                            data-colors='["--vz-success-rgb, 0.50" , "--vz-transparent"]'
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="row align-items-end g-0">
                                    ...
                                    <div class="col-6">
                                        <div class="apex-charts crypto-widget"
                                            data-colors='["--vz-danger-rgb, 0.50", "--vz-transparent"]'
                        ...
                        <table class="table table-hover table-borderless table-centered align-middle table-nowrap mb-0">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td>$53,914.025</td>
                                    <td>1.25634801</td>
                                    <td><a href="<?php echo e(URL::asset('/apps-crypto-buy-sell')); ?>" class="btn btn-sm btn-soft-secondary">Trade</a>
                                    </td>
                                </tr><!-- end -->
                                <tr>
                                    <td>
                ...
                <div class="card-body p-0">
                    <ul class="list-group list-group-flush border-dashed mb-0">
                        <li class="list-group-item d-flex align-items-center">
                            <div class="flex-shrink-0">
                                <img src="<?php echo e(URL::asset('assets/images/svg/crypto-icons/btc.svg')); ?>" class="avatar-xs" alt="">
                            </div>
                            <div class="flex-grow-1 ms-3">
                        ...
                        <li class="list-group-item d-flex align-items-center">
                            <div class="flex-shrink-0">
                                <img src="<?php echo e(URL::asset('assets/images/svg/crypto-icons/eth.svg')); ?>" class="avatar-xs" alt="">
                            </div>
                            <div class="flex-grow-1 ms-3">
                        ...
                        <li class="list-group-item d-flex align-items-center">
                            <div class="flex-shrink-0">
                                <img src="<?php echo e(URL::asset('assets/images/svg/crypto-icons/aave.svg')); ?>" class="avatar-xs" alt="">
                            </div>
                            <div class="flex-grow-1 ms-3">
                        ...
                        <li class="list-group-item d-flex align-items-center">
                            <div class="flex-shrink-0">
                                <img src="<?php echo e(URL::asset('assets/images/svg/crypto-icons/doge.svg')); ?>" class="avatar-xs" alt="">
                            </div>
                            <div class="flex-grow-1 ms-3">
                        ...
                        <li class="list-group-item d-flex align-items-center">
                            <div class="flex-shrink-0">
                                <img src="<?php echo e(URL::asset('assets/images/svg/crypto-icons/bnb.svg')); ?>" class="avatar-xs" alt="">
                            </div>
                            <div class="flex-grow-1 ms-3">
                        ...
                        <li class="list-group-item d-flex align-items-center">
                            <div class="flex-shrink-0">
                                <img src="<?php echo e(URL::asset('assets/images/svg/crypto-icons/ltc.svg')); ?>" class="avatar-xs" alt="">
                            </div>
                            <div class="flex-grow-1 ms-3">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <div class="d-flex align-middle">
                        <div class="flex-shrink-0">
                            <img src="<?php echo e(URL::asset('assets/images/small/img-1.jpg')); ?>" class="rounded img-fluid" style="height: 60px;"
                                alt="">
                        </div>
                        <div class="flex-grow-1 ms-3">
                    ...
                    <div class="d-flex mt-4">
                        <div class="flex-shrink-0">
                            <img src="<?php echo e(URL::asset('assets/images/small/img-2.jpg')); ?>" class="rounded img-fluid" style="height: 60px;"
                                alt="">
                        </div>
                        <div class="flex-grow-1 ms-3">
                    ...
                    <div class="d-flex mt-4">
                        <div class="flex-shrink-0">
                            <img src="<?php echo e(URL::asset('assets/images/small/img-3.jpg')); ?>" class="rounded img-fluid" style="height: 60px;"
                                alt="">
                        </div>
                        <div class="flex-grow-1 ms-3">
                    ...
                    <div class="d-flex mt-4">
                        <div class="flex-shrink-0">
                            <img src="<?php echo e(URL::asset('assets/images/small/img-6.jpg')); ?>" class="rounded img-fluid" style="height: 60px;"
                                alt="">
                        </div>
                        <div class="flex-grow-1 ms-3">
...
<?php echo $__env->make('layouts.layouts-vertical-hovered', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Tarun\Laravel Admins\velzon_laravel\Laravel\minimal\resources\views/layouts-vertical-hovered.blade.php ENDPATH**/ ?>