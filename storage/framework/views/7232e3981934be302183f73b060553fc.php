                            ...
                            <div class="col-md-6">
                                ...
                                <div class="input-group mb-3">
                                    <input type="text" class="form-control rounded-end flag-input" readonly
                                           placeholder="--Chose Letter Type--" data-bs-toggle="dropdown" aria-expanded="false"/>
...
<?php echo $__env->make('layouts.sales layout.layouts-detached', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/Loan_serv_L/resources/views/sales/approvals/reminder-letter.blade.php ENDPATH**/ ?>