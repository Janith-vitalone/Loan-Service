                    ...
                    <div class="d-flex mb-3">
                        <div class="flex-grow-1">
                            <lord-icon src="https://cdn.lordicon.com/fhtaantg.json" trigger="loop"
                                colors="primary:#25a0e2,secondary:#00bd9d" style="width:55px;height:55px">
                            </lord-icon>
                        </div>
                    ...
                    <div class="d-flex mb-3">
                        <div class="flex-grow-1">
                            <lord-icon src="https://cdn.lordicon.com/qhviklyi.json" trigger="loop"
                                colors="primary:#25a0e2,secondary:#00bd9d" style="width:55px;height:55px"></lord-icon>
                        </div>
                        <div class="flex-shrink-0">
                            <a href="javascript:void(0);" class="badge badge-soft-secondary badge-border">BTC</a>
                            <a href="javascript:void(0);" class="badge badge-soft-secondary badge-border">ETH</a>
                ...
                <table class="table align-middle table-nowrap" id="customerTable">
                    ...
                    <tbody class="list form-check-all">
                        <tr>
                            ...
                            <td class="status">
                                <span class="badge badge-soft-primary fs-11"><i class="ri-time-line align-bottom"></i>
                                    Processing</span>
                            </td>
                        </tr>
                        <!--end tr-->
                        ...
                        <tr>
                            ...
                            <td class="currency_name">
                                <div class="d-flex align-items-center">
                                    <img src="<?php echo e(URL::asset('build/images/svg/crypto-icons/eur.svg')); ?>" alt="" class="avatar-xxs me-2">
                                    EUR
                                </div>
                            </td>
                        ...
                        <tr>
                            ...
                            <td class="currency_name">
                                <div class="d-flex align-items-center">
                                    <img src="<?php echo e(URL::asset('build/images/svg/crypto-icons/gbp.svg')); ?>" alt="" class="avatar-xxs me-2">
                                    GBP
                                </div>
                            </td>
                            <td class="form_name">Wallet</td>
                        ...
                        <tr>
                            ...
                            <td class="currency_name">
                                <div class="d-flex align-items-center">
                                    <img src="<?php echo e(URL::asset('build/images/svg/crypto-icons/jpy.svg')); ?>" alt="" class="avatar-xxs me-2">
                                    JPY
                                </div>
                            </td>
                        ...
                        <tr>
                            ...
                            <td class="currency_name">
                                <div class="d-flex align-items-center">
                                    <img src="<?php echo e(URL::asset('build/images/svg/crypto-icons/xrp.svg')); ?>" alt="" class="avatar-xxs me-2">
                                    XRP
                                </div>
                            </td>
                            <td class="form_name">Wallet</td>
                        ...
                        <tr>
                            ...
                            <td class="currency_name">
                                <div class="d-flex align-items-center">
                                    <img src="<?php echo e(URL::asset('build/images/svg/crypto-icons/xpm.svg')); ?>" alt="" class="avatar-xxs me-2">
                                    XPM
                                </div>
                            </td>
                        ...
                        <tr>
                            ...
                            <td class="currency_name">
                                <div class="d-flex align-items-center">
                                    <img src="<?php echo e(URL::asset('build/images/svg/crypto-icons/ppt.svg')); ?>" alt="" class="avatar-xxs me-2">
                                    PPT
                                </div>
                            </td>
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/Loan_serv_L/resources/views/apps-crypto-transactions.blade.php ENDPATH**/ ?>