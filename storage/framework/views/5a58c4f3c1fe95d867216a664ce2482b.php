<?php $__env->startSection('title'); ?>
    <?php echo app('translator')->get('translation.pricing'); ?>
        ...
        <div class="col-xxl-3 col-lg-6">
            <div class="card pricing-box ribbon-box right">
                <div class="card-body bg-light m-2 p-4">
                    ...
                    <p class="text-muted">This plan is for those who have a team alredy and running a large business.
                    </p>
                    <ul class="list-unstyled vstack gap-3">
                        <li>
                            <div class="d-flex">
                            ...
                            <div>
                                ...
                                <div class="mt-4">
                                    <a href="javascript:void(0);"
                                        class="btn btn-soft-primary w-100 waves-effect waves-light">Sign up free</a>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="card pricing-box ribbon-box right">
                        <div class="card-body p-4 m-2">
                            ...
                            <div>
                                ...
                                <div class="mt-4">
                                    <a href="javascript:void(0);"
                                        class="btn btn-primary w-100 waves-effect waves-light">Get started</a>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="card pricing-box">
                        <div class="card-body p-4 m-2">
                            ...
                            <div>
                                ...
                                <div class="mt-4">
                                    <a href="javascript:void(0);"
                                        class="btn btn-soft-primary w-100 waves-effect waves-light">Get started</a>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-6">
                        <div class="card-body h-100">
                            ...
                            <div class="text-center plan-btn mt-2">
                                <a href="javascript:void(0);" class="btn btn-primary w-sm waves-effect waves-light">Sign
                                    up</a>
                            </div>
                        </div>
                    </div>
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Tarun\Laravel Admins\velzon_laravel\Laravel\minimal\resources\views/pages-pricing.blade.php ENDPATH**/ ?>