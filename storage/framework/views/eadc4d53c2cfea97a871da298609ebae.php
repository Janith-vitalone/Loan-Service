                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="d-flex align-items-center">
                                                <div class="flex-shrink-0">
                                                    <img src="<?php echo e(URL::asset('build/images/brands/dribbble.png')); ?>" alt="" class="avatar-xxs rounded-circle image_src object-cover">
                                                </div>
            ...
            <div class="card" id="company-view-detail">
                <div class="card-body text-center">
                    <div class="position-relative d-inline-block">
                        <div class="avatar-md">
                            <div class="avatar-title bg-light rounded-circle">
                                <img src="<?php echo e(URL::asset('build/images/brands/mail_chimp.png')); ?>" alt="" class="avatar-sm rounded-circle object-cover">
                            </div>
                        </div>
                    </div>
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/Loan_serv_L/resources/views/apps-crm-companies.blade.php ENDPATH**/ ?>