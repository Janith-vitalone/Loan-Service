            ...
            <div class="row g-3">
                ...
                <div class="col-md-auto ms-auto">
                    <div class="d-flex hastck gap-2 flex-wrap">
                        ...
                        <button data-bs-toggle="modal" data-bs-target="#adddeals" class="btn btn-primary"><i
    ...
    <div class="row row-cols-xxl-5 row-cols-lg-3 row-cols-md-2 row-cols-1">
        <div class="col">
            <div class="card border-0 overflow-hidden">
                <a class="card-body bg-soft-primary" data-bs-toggle="collapse" href="#leadDiscovered" role="button"
            ...
            <div class="collapse show" id="leadDiscovered">
                <div class="card mb-1">
                    ...
                    <div class="collapse border-top border-top-dashed" id="leadDiscovered1">
                        <div class="card-body">
                            <h6 class="fs-14 mb-1">Nesta Technologies <small class="badge badge-soft-primary">4
                                    Days</small></h6>
                        ...
                        <div class="card-footer hstack gap-2">
                            <button class="btn btn-success btn-sm w-100"><i class="ri-phone-line align-bottom me-1"></i>
                                Call</button>
        ...
        <div class="col">
            <div class="card border-0 overflow-hidden">
                <a class="card-body bg-soft-primary" data-bs-toggle="collapse" href="#contactInitiated" role="button"
            ...
            <div class="collapse show" id="contactInitiated">
                ...
                <div class="card mb-1">
                    ...
                    <div class="collapse border-top border-top-dashed" id="contactInitiated2">
                        <div class="card-body">
                            <h6 class="fs-14 mb-1">Zoetic Fashion <small class="badge badge-soft-success">25
                                    Days</small></h6>
                            <p class="text-muted">As a company grows however, you find it's not as easy
                                to shout across</p>
                            <ul class="list-unstyled vstack gap-2 mb-0">
        ...
        <div class="col">
            <div class="card border-0 overflow-hidden">
                <a class="card-body bg-soft-primary" data-bs-toggle="collapse" href="#needsIdentified" role="button"
            ...
            <div class="collapse show" id="needsIdentified">
                <div class="card mb-1">
                    ...
                    <div class="collapse border-top border-top-dashed" id="needsIdentified1">
                        <div class="card-body">
                            <h6 class="fs-14 mb-1">Alexis Clarke <small class="badge badge-soft-primary">7
                                    Days</small></h6>
                            <p class="text-muted">As a company grows however, you find it's not as easy
                                to shout across</p>
                            <ul class="list-unstyled vstack gap-2 mb-0">
                ...
                <div class="card mb-1">
                    ...
                    <div class="collapse border-top border-top-dashed" id="needsIdentified2">
                        <div class="card-body">
                            <h6 class="fs-14 mb-1">Meta4Systems <small class="badge badge-soft-success">35
                                    Days</small></h6>
                            <p class="text-muted">As a company grows however, you find it's not as easy
                                to shout across</p>
                            <ul class="list-unstyled vstack gap-2 mb-0">
                ...
                <div class="card mb-1">
                    ...
                    <div class="collapse border-top border-top-dashed" id="needsIdentified3">
                        <div class="card-body">
                            <h6 class="fs-14 mb-1">Syntyce Solutions <small class="badge badge-soft-primary">15
                                    Days</small></h6>
                            <p class="text-muted">As a company grows however, you find it's not as easy
                                to shout across</p>
                            <ul class="list-unstyled vstack gap-2 mb-0">
                ...
                <div class="card mb-1">
                    ...
                    <div class="collapse border-top border-top-dashed" id="needsIdentified6">
                        <div class="card-body">
                            <h6 class="fs-14 mb-1">iTest Factory <small class="badge badge-soft-primary">42
                                    Days</small></h6>
                            <p class="text-muted">As a company grows however, you find it's not as easy
                                to shout across</p>
                            <ul class="list-unstyled vstack gap-2 mb-0">
        ...
        <div class="col">
            <div class="card border-0 overflow-hidden">
                <a class="card-body bg-soft-primary" data-bs-toggle="collapse" href="#meetingArranged" role="button"
            ...
            <div class="collapse show" id="meetingArranged">
                <div class="card mb-1">
                    ...
                    <div class="collapse border-top border-top-dashed" id="meetingArranged1">
                        <div class="card-body">
                            <h6 class="fs-14 mb-1">Nesta Technologies <small class="badge badge-soft-primary">10
                                    Days</small></h6>
                            <p class="text-muted">As a company grows however, you find it's not as easy
                                to shout across</p>
                            <ul class="list-unstyled vstack gap-2 mb-0">
        ...
        <div class="col">
            <div class="card border-0 overflow-hidden">
                <a class="card-body bg-soft-primary" data-bs-toggle="collapse" href="#offerAccepted" role="button"
            ...
            <div class="collapse show" id="offerAccepted">
                ...
                <div class="card mb-1 ribbon-box ribbon-fill ribbon-sm">
                    ...
                    <div class="collapse border-top border-top-dashed" id="offerAccepted2">
                        <div class="card-body">
                            <h6 class="fs-14 mb-1">Nesta Technologies <small class="badge badge-soft-success">47
                                    Days</small></h6>
                            <p class="text-muted">As a company grows however, you find it's not as easy
                                to shout across</p>
                            <ul class="list-unstyled vstack gap-2 mb-0">
...
<?php $__env->startSection('script'); ?>
    <script src="<?php echo e(URL::asset('/assets/libs/cleave.js/cleave.min.js')); ?>"></script>
    <script src="<?php echo e(URL::asset('/assets/js/pages/crm-deals.init.js')); ?>"></script>
    <script src="<?php echo e(URL::asset('assets/libs/sweetalert2/sweetalert2.min.js')); ?>"></script>
    <script src="<?php echo e(URL::asset('/assets/js/app.js')); ?>"></script>
<?php $__env->stopSection(); ?>

<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Tarun\Laravel Admins\velzon_laravel\Laravel\minimal\resources\views/apps-crm-deals.blade.php ENDPATH**/ ?>