        ...
        <div class="col-lg-12">
            <div class="card">
                <div class="card-header">
                    <h4 class="card-title mb-0">Voucher Print</h4>
                </div><!-- end card header -->
                <div class="card-body">
                    <form action="">
                        <div class="row">
                        ...
                        <div class="row">
                            <div class="col-xl-6">
                                ...
                                <div class="input-group mb-3">
                                    ...
                                    <div class=" gap-lg-3 d-md-block">
                                        <button class="btn btn-soft-secondary me-md-2" type="button">Search</button>
                                        <button class="btn btn-soft-danger" type="button">Print</button>
                                    </div>
                                </div>
                            </div>
                        </div><!-- end row -->
...
<?php echo $__env->make('layouts.sales layout.layouts-detached', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/Loan_serv_L/resources/views/sales/approvels/voucher-print-form.blade.php ENDPATH**/ ?>