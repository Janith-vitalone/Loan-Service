                                        ...
                                        <form action="javascript:void(0);">
                                            <div class="row g-3">
                                                ...
                                                <div class="col-xxl-6">
                                                    ...
                                                    <input type="password" class="form-control" id="passwordInput" value="451326546" placeholder="Enter your email">
                                                </div><!--end col-->
                                                <div class="col-lg-12">
                                ...
                                <div class="row g-0">
                                    ...
                                    <div class="col-lg-5">
                                        <div class="subscribe-modals-cover h-100">
                                            <img src="<?php echo e(URL::asset('build/images/modals/auth-one-bg.jpg')); ?>" alt="" class="h-100 w-100 object-cover" style="clip-path: polygon(100% 0%, 100% 100%, 100% 100%, 0% 100%, 25% 50%, 0% 0%);">
                                        </div>
                                    </div>
                                </div>
                            </div><!-- /.modal-content -->
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/Loan_serv_L/resources/views/ui-modals.blade.php ENDPATH**/ ?>