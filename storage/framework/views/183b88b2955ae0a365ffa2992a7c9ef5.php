...
<?php $__env->startSection('content'); ?>
    ...
    <div class="row mt-4">
        <div class="col-xl-3 col-lg-6">
            <div class="card ribbon-box right overflow-hidden">
                <div class="card-body text-center p-4">
                    ...
                    <img src="<?php echo e(URL::asset('build/images/companies/img-1.png')); ?>" alt="" height="45">
                    <h5 class="mb-1 mt-4"><a href="<?php echo e(URL::asset('/apps-ecommerce-seller-details')); ?>" class="link-secondary">Force
                            Medicines</a></h5>
                    ...
                    <div class="mt-4">
                        <a href="<?php echo e(URL::asset('/apps-ecommerce-seller-details')); ?>" class="btn btn-light w-100">View Details</a>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="col-xl-3 col-lg-6">
            <div class="card">
                <div class="card-body text-center p-4">
                    <img src="<?php echo e(URL::asset('build/images/companies/img-2.png')); ?>" alt="" height="45">
                    <h5 class="mb-1 mt-4"><a href="<?php echo e(URL::asset('/apps-ecommerce-seller-details')); ?>" class="link-secondary">Micro
                            Design</a></h5>
        ...
        <div class="col-xl-3 col-lg-6">
            <div class="card">
                <div class="card-body text-center p-4">
                    <img src="<?php echo e(URL::asset('build/images/companies/img-3.png')); ?>" alt="" height="45">
                    <h5 class="mb-1 mt-4"><a href="<?php echo e(URL::asset('/apps-ecommerce-seller-details')); ?>" class="link-secondary">Nesta
                            Technologies</a></h5>
            ...
            <div class="card ribbon-box right overflow-hidden">
                <div class="card-body text-center p-4">
                    <div class="ribbon ribbon-primary ribbon-shape trending-ribbon"><i
                            class="ri-flashlight-fill text-white align-bottom"></i> <span
                            class="trending-ribbon-text">Trending</span></div>
                    <img src="<?php echo e(URL::asset('build/images/companies/img-4.png')); ?>" alt="" height="45">
                    <h5 class="mb-1 mt-4"><a href="<?php echo e(URL::asset('/apps-ecommerce-seller-details')); ?>" class="link-secondary">iTest
                            Factory</a></h5>
        ...
        <div class="col-xl-3 col-lg-6">
            <div class="card">
                <div class="card-body text-center p-4">
                    <img src="<?php echo e(URL::asset('build/images/companies/img-5.png')); ?>" alt="" height="45">
                    <h5 class="mb-1 mt-4"><a href="<?php echo e(URL::asset('/apps-ecommerce-seller-details')); ?>"
            ...
            <div class="card ribbon-box right overflow-hidden">
                <div class="card-body text-center p-4">
                    <div class="ribbon ribbon-primary ribbon-shape trending-ribbon"><i
                            class="ri-flashlight-fill text-white align-bottom"></i> <span
                            class="trending-ribbon-text">Trending</span></div>
                    <img src="<?php echo e(URL::asset('build/images/companies/img-6.png')); ?>" alt="" height="45">
                    <h5 class="mb-1 mt-4"><a href="<?php echo e(URL::asset('/apps-ecommerce-seller-details')); ?>"
            ...
            <div class="card ribbon-box right overflow-hidden">
                <div class="card-body text-center p-4">
                    <div class="ribbon ribbon-primary ribbon-shape trending-ribbon"><i
                            class="ri-flashlight-fill text-white align-bottom"></i> <span
                            class="trending-ribbon-text">Trending</span></div>
                    <img src="<?php echo e(URL::asset('build/images/companies/img-7.png')); ?>" alt="" height="45">
                    <h5 class="mb-1 mt-4"><a href="<?php echo e(URL::asset('/apps-ecommerce-seller-details')); ?>" class="link-secondary">Syntyce
                            Solutions</a></h5>
        ...
        <div class="col-xl-3 col-lg-6">
            <div class="card">
                <div class="card-body text-center p-4">
                    <img src="<?php echo e(URL::asset('build/images/companies/img-8.png')); ?>" alt="" height="45">
                    <h5 class="mb-1 mt-4"><a href="<?php echo e(URL::asset('/apps-ecommerce-seller-details')); ?>" class="link-secondary">Zoetic
                            Fashion</a></h5>
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/Loan_serv_L/resources/views/apps-ecommerce-sellers.blade.php ENDPATH**/ ?>