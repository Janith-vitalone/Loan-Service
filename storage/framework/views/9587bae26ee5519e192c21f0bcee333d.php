                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="row align-items-end g-0">
                                    ...
                                    <div class="col-6">
                                        <div class="apex-charts crypto-widget"
                                            data-colors='["--vz-danger-rgb, 0.5", "--vz-transparent"]'
                    ...
                    <div class="swiper-slide">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="d-flex align-items-center">
                                    <img src="<?php echo e(URL::asset('build/images/svg/crypto-icons/xmr.svg')); ?>"
                                        class="bg-light rounded-circle p-1 avatar-xs img-fluid" alt="">
                    ...
                    <div class="swiper-slide">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="d-flex align-items-center">
                                    <img src="<?php echo e(URL::asset('build/images/svg/crypto-icons/mkr.svg')); ?>"
                                        class="bg-light rounded-circle p-1 avatar-xs img-fluid" alt="">
                        ...
                        <table class="table align-middle table-nowrap" id="customerTable">
                            ...
                            <tbody class="list form-check-all">
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-flex align-items-center fw-medium">
                                            ...
                                            <a href="javascript:void(0)" class="currency_name link-secondary">Bitcoin
                                                (BTC)</a>
                                        </div>
                                    </td>
                                    ...
                                    <td>
                                        <div class="d-flex align-items-center fw-medium">
                                            <img src="<?php echo e(URL::asset('build/images/svg/crypto-icons/eth.svg')); ?>" alt=""
                                                class="avatar-xxs me-2" />
                                            <a href="javascript:void(0)" class="currency_name link-secondary">Ethereum
                                                (ETH)</a>
                                        </div>
                                    </td>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-flex align-items-center fw-medium">
                                            <img src="<?php echo e(URL::asset('build/images/svg/crypto-icons/xrp.svg')); ?>" alt=""
                                                class="avatar-xxs me-2" />
                                            <a href="javascript:void(0)" class="currency_name link-secondary">Ripple
                                                (XRP)</a>
                                        </div>
                                    </td>
                                    ...
                                    <td>
                                        <div class="d-flex align-items-center fw-medium">
                                            <img src="<?php echo e(URL::asset('build/images/svg/crypto-icons/xmr.svg')); ?>" alt=""
                                                class="avatar-xxs me-2" />
                                            <a href="javascript:void(0)" class="currency_name link-secondary">Monero
                                                (XMR)</a>
                                        </div>
                                    </td>
                                    ...
                                    <td>
                                        <div class="d-flex align-items-center fw-medium">
                                            <img src="<?php echo e(URL::asset('build/images/svg/crypto-icons/ltc.svg')); ?>" alt=""
                                                class="avatar-xxs me-2" />
                                            <a href="javascript:void(0)" class="currency_name link-secondary">Litecoin
                                                (LTC)</a>
                                        </div>
                                    </td>
                                    ...
                                    <td>
                                        <div class="d-flex align-items-center fw-medium">
                                            <img src="<?php echo e(URL::asset('build/images/svg/crypto-icons/aave.svg')); ?>" alt=""
                                                class="avatar-xxs me-2" />
                                            <a href="javascript:void(0)" class="currency_name link-secondary">Aave
                                                (AAVE)</a>
                                        </div>
                                    </td>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-flex align-items-center fw-medium">
                                            <img src="<?php echo e(URL::asset('build/images/svg/crypto-icons/mkr.svg')); ?>" alt=""
                                                class="avatar-xxs me-2" />
                                            <a href="javascript:void(0)" class="currency_name link-secondary">Maker
                                                (MKR)</a>
                                        </div>
                                    </td>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-flex align-items-center fw-medium">
                                            <img src="<?php echo e(URL::asset('build/images/svg/crypto-icons/yfi.svg')); ?>" alt=""
                                                class="avatar-xxs me-2" />
                                            <a href="javascript:void(0)" class="currency_name link-secondary">Yearn.finance
                                                (YFI)</a>
                                        </div>
                                    </td>
        ...
        <div class="col-xxl-3">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="d-flex mb-3">
                        <div class="flex-shrink-0">
                            <img src="<?php echo e(URL::asset('build/images/svg/crypto-icons/fil.svg')); ?>" alt="" class="avatar-xxs" />
                        </div>
                        <div class="flex-grow-1 ms-3">
                    ...
                    <div class="d-flex mb-3">
                        <div class="flex-shrink-0">
                            <img src="<?php echo e(URL::asset('build/images/svg/crypto-icons/dot.svg')); ?>" alt="" class="avatar-xxs" />
                        </div>
                        <div class="flex-grow-1 ms-3">
                    ...
                    <div>
                        <a href="<?php echo e(URL::asset('/apps-crypto-transactions')); ?>" class="btn btn-soft-primary w-100">View All Transactions <i
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/Loan_serv_L/resources/views/apps-crypto-wallet.blade.php ENDPATH**/ ?>