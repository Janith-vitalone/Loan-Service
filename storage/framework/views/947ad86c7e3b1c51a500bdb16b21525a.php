<?php $__env->startSection('title'); ?>
    <?php echo app('translator')->get('translation.lists'); ?>
...
&lt;/ul&gt;</code></pre>
        ...
        <div class="col-xxl-4 col-xl-6">
            <div class="card">
                ...
                <div class="card-body">
                    <p class="text-muted">Use <code>&lt;a&gt;</code> tag to create actionable list group items with
...
&lt;/div&gt;</code></pre>
        ...
        <div class="col-xxl-4 col-xl-6">
            <div class="card">
                ...
                <div class="card-body">
                    <p class="text-muted">Use <code>&lt;button&gt;</code> tag to create actionable list group items
...
&lt;/ul&gt;</code></pre>
        ...
        <div class="col-xxl-4 col-xl-6">
            <div class="card">
                ...
                <div class="card-body">
                    <p class="text-muted">Contextual classes also work with <code>.list-group-item-action</code>. Note
                        the addition of the hover styles here not present in the previous example.</p>
                    <div class="live-preview">
                        <div class="list-group">
...
&lt;/div&gt;</code></pre>
        ...
        <div class="col-xxl-4 col-xl-6">
            <div class="card">
                ...
                <div class="card-body">
                    <p class="text-muted">Use <code>list-group-fill-</code> with modifier class to style list items
                        with a stateful background and color.</p>
                    <div class="live-preview">
                        <ul class="list-group">
                            <li class="list-group-item">Dapibus ac facilisis in</li>
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <p class="text-muted">Add nearly any HTML within, even for linked list groups like the one below,
                        with the help of <a href="https://getbootstrap.com/docs/5.1/utilities/flex/">flexbox utilities</a>.
                    </p>
                    <div class="live-preview">
                        <div class="list-group">
    ...
    <div class="row">
        <div class="col-xxl-4 col-xl-6">
            <div class="card">
                ...
                <div class="card-body">
                    <p class="text-muted">Use badges to any list group item to show unread counts, activity, and more
                        with the help of some <a href="https://getbootstrap.com/docs/5.1/utilities/">utilities</a>.</p>
                    <div class="live-preview">
                        <ul class="list-group">
                            ...
                            <li class="list-group-item d-flex justify-content-between align-items-center">
                                Meeting with daron to review the intake form <span
                                    class="badge badge-soft-danger">Low</span>
                            </li>
                            <li class="list-group-item d-flex justify-content-between align-items-center">
                                Check uikings theme and give customer support <span
                                    class="badge badge-soft-secondary">Medium</span>
                            </li>
                            <li class="list-group-item d-flex justify-content-between align-items-center">
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/Loan_serv_L/resources/views/ui-lists.blade.php ENDPATH**/ ?>